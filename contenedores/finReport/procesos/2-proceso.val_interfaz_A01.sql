...
BEGIN
	BEGIN
		...
		/*
			validacion de campo cod_persona si existe en la tabla relacion interno.tipo_persona_rel
		*/
		...
		LOOP
			...
			VALUES(
				...
				,rec.valor_contable
				,'cod_persona: No se encuentra el codigo del campo cod_persona en la tabla interno.tipo_persona_rel'
			);

		END LOOP;

		/*
			validacion de campo cod_titulo_3 si existe en la tabla relacion interno.operacion_titulo_rel
		*/
		...
		LOOP
			...
			VALUES(
				...
				,rec.numero_solicitud
				,rec.valor_contable
				,'cod_titulo_3: No se encuentra el codigo del campo cod_titulo_3 en la tabla interno.operacion_titulo_rel'
			);	

		END LOOP;

		/*
			validacion de campo cod_deudor si existe en la tabla relacion interno.tipo_deudor_rel
		*/
		...
		LOOP
			...
			VALUES(
				...
				,rec.numero_solicitud
				,rec.valor_contable
				,'cod_deudor: No se encuentra el codigo del campo cod_deudor en la tabla interno.tipo_deudor_rel'
			);			
		...
		/*
			validacion de campo cod_tipo_obligacion si existe en la tabla relacion interno.tabla_banco_126_rel
		*/
		...
		LOOP
			...
			VALUES(
				...
				,rec.numero_solicitud
				,rec.valor_contable
				,'cod_tipo_obligacion: No se encuentra el codigo del campo cod_tipo_obligacion en la tabla interno.tabla_banco_126_rel'
			);			
